...
set val(rp) AODV;                       # Protocolos de roteamento
set val(nn) 52 ;                        # Numero de nodes moveis
set val(speed) 5 ;                      # Velocidade dos nodes (m/s)
...
set nfile [open AODV.nam w]
$nsim namtrace-all-wireless $nfile $val(x) $val(y)

set tfile [open AODV.tr w]
